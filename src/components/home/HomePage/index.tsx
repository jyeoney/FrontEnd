  ...
  const features = [
    {
      ...
      description:
        '스터디 모집, 참여, 진행 및 관리까지 모든 것을 간편하게 할 수 있는 올인원 개발 스터디 플랫폼입니다.  더 이상 여러 서비스를 돌아다닐 필요 없이 한 곳에서 해결하세요!',
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-lg text-gray-500 mb-8 whitespace-pre-line">
            {
              'DevOnOff는 ‘Dev’와 ‘On/Off’를 결합한 이름으로,\n 개발 스터디 모집, 참여, 진행 및 관리까지 모든 것을 간편하게 할 수 있는 올인원 개발 스터디 플랫폼입니다. '
            }
          </p>
          <button
